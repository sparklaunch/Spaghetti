const refineText = chunks => {
  ...
  const beforeCapital = rawText.replace(/[A-Z]/g, " ").split(" ")[0];

  // Phase 1: Get the actual chunk before "future".
  const phase1 = beforeCapital.split("future")[0];
